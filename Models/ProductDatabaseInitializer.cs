        ...
        private static List<Product> GetProducts()
        {
            var products = new List<Product>
            {
                ...
                new Product
                {
                  ...
                  Description = "You will have endless fun with this one quarter size fire truck.",
                ...
                new Product
                {
                  ...
                  Description = "is it a boat or a ship. Let this floating vehicle deceide by using its" +
